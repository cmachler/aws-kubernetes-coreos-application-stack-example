...
# COUNTER_DNS variable
counter_dns = os.environ['COUNTER_DNS']
...
%s
  <script type="text/javascript" src="http://{counter_dns}/counter/count.php?page=forum"><!--//--></script>
  </body>
</html>
'''.format(counter_dns=counter_dns)
...
httpd = make_server('0.0.0.0', 9090, Dispatcher)
